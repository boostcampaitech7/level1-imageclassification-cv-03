...
def main():
    ...
    model_paths = [
        ...
        os.path.join(save_ensemble_path, "resnext32_full.pt"),
        os.path.join(save_ensemble_path, "eva_large_patch14_336_full.pt"),
    ]
    ...
    # 테스트 함수 호출
    predictions = inference_tta_ensemble(
...
if __name__ == "__tta_ensemble_test__": # python tta_ensemble_test.py
    main()